...
import { get_knowledge_firstaccept_data } from '@/api/chart'
...
export default {
  ...
  methods: {
    async get_data() {
      ...
      const res = await get_knowledge_firstaccept_data(course_id, store.getters.account)
