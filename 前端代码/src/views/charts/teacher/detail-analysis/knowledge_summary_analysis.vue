...
import { get_knowledge_summary_data } from '@/api/chart'
...
export default {
  ...
  methods: {
    async get_data(course_id) {
      ...
      const res = await get_knowledge_summary_data(course_id, store.getters.account)
      ...
      this.option.series[2].data = res_data.commit
      this.chart.clear()
